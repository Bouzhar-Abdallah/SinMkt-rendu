                        ...
                        <tbody class="bg-white divide-y ">
                            ...
                            if (isset($_GET["a"])) {
                                if ($_GET["a"] === 'newProductLine') {
                                    ...
                                    <tr class="text-dgray">
                                <!-- add -->
                                <form action="../pages/?c=newArrivals&a=saveNew" id="productInfo" name="productInfo" method="post" enctype="multipart/form-data">
                                <td class="px-4 py-3">
                            ...
                            <tr class="text-dgray">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center space-x-4 text-sm">
                                        ...
                                        <div class=" w-6 h-6   rounded-full md:block">
                                        <a href="index.php<?php echo '?c='.basename(__FILE__, 'a.php').'&a=delete&id='.$value["id_newArrivals"] ?>">
